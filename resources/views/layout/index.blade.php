      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 mb-5 mb-md-0">
              ...
              <div class="img-border">
                <a href="https://vimeo.com/28959265" class="popup-vimeo image-play">
                  ...
                  <img src="{{asset('front/images/hero_3.jpg')}}" alt="" class="img-fluid">
                </a>
              </div>

              <img src="{{asset('front/images/hero_1.jpg')}}" alt="Image" class="img-fluid image-absolute">
          ...
          <div class="col-md-5 ml-auto">
            ...
            <p class="mb-4">Booking kost merupakan sebuah aplikasi kost yang dimiliki oleh pemilik individu kost. Yang bertujuan untuk mempermudah pemilik untuk mengontrol kostannya dan mempermudah pemesan untuk memesan kostan tersebut. </p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="nonloop-block-14 owl-carousel">
          ...
          <div class="p-4">
            <div class="d-flex block-testimony">
              ...
              <div>
                <h2 class="h5">Meidini Riski Amalia</h2>
                <blockquote>&ldquo;Semoga dengan dibuatnya aplikasi ini memudahkan pemesan untuk memesan kostan menggunakan aplikasi ini.  &rdquo;</blockquote>
              </div>
            </div>  
          </div>
          <div class="p-4">
            <div class="d-flex block-testimony">
              ...
              <div>
                <h2 class="h5">Princesa Virginia Addyska</h2>
                <blockquote>&ldquo;Semoga dengan dibuatnya aplikasi ini, bisa mempermudah pemilik kost menghandle kostan miliknya.  &rdquo;</blockquote>
              </div>
            </div>
          </div>
          <!-- <div class="p-4">
